...
class AdminUpdatePostControllerTest extends ControllerTestContext {
    private static final String TAG = Tags.ADMIN_POST.tagName();
    private static final String DESCRIPTION = Tags.ADMIN_POST.descriptionWith("수정");
    ...
    void success() {
        ...
        var body = new AdminUpdatePostController.Request(
            "수정할 작성자명",
            "수정할 제목",
            "수정할 내용"
        );
