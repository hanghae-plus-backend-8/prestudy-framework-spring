...
class AdminDeleteCommentControllerTest extends ControllerTestContext {
    private static final String TAG = Tags.ADMIN_COMMENT.tagName();
    private static final String DESCRIPTION = Tags.ADMIN_COMMENT.descriptionWith("삭제");
