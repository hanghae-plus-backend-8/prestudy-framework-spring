...
public class CreateCommentControllerTest extends ControllerTestContext {
    private static final String TAG = Tags.COMMENT.tagName();
    private static final String DESCRIPTION = Tags.COMMENT.descriptionWith("생성");
    ...
    void success() {
        ...
        var body = new CreateCommentController.Request(
            1L,
            1L,
            "댓글 내용"
        );
